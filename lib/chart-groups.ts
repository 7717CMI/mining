...
export const CHART_GROUPS: ChartGroup[] = [
  ...
  },
  {
    ...
    label: 'Distributor & Customer Intelligence',
    description: 'Distributor and customer databases with contact details',
    charts: ['distributor-table', 'customer-intelligence-database'],
    icon: '📦'
  }
]
